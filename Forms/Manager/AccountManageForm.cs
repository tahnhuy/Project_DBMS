    ...
    public partial class AccountManageForm : Form
    {
        ...
        private void btn_Statistics_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    message += $"{row["Statistic"]}: {row["Value"]}\n";
                }
        ...
        private void btn_Backup_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable result = AccountRepository.BackupAccounts();
            ...
            {
                MessageBox.Show("Lỗi khi backup: " + ex.Message, "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
